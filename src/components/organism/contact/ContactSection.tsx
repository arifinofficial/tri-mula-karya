    ...
    return (
        <section className='pt-50 pb-37.5 px-9 xl:px-21 bg-primary border-b border-foreground/30 md:border-0'>
            <div className='grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-8'>
                <div className='md:col-span-6 flex flex-col justify-between gap-52'>
                    ...
                    <div className='flex flex-col gap-17.5 '>
                        <div className='flex flex-col gap-3.75 lg:w-[80%] xl:w-[70%] 2xl:w-[60%]'>
            ...
            onWheel={() => setIsActive(false)} // ← scroll di atas wrapper → tutup overlay
        >
            <iframe
                ...
                className="w-full aspect-square xl:h-[100vh]"
            />

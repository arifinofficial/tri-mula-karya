    ...
    return (
        <section className='px-9 xl:px-21 pt-37.5 pb-25 bg-primary z-10 relative '>
            ...
            <div className='grid grid-cols-6 md:grid-cols-12 gap-4 lg:gap-8 mt-12.5 xl:mt-25'>
                <div className='hidden md:block col-span-3 md:col-span-5 xl:col-span-2'>
                ...
                <div className='col-span-6 order-1 md:col-span-5 xl:row-span-2 xl:col-span-4 xl:col-start-4 xl:row-start-1'>
                    <p className='text-base md:text-lg xl:text-xl  xl:mt-0' dangerouslySetInnerHTML={{ __html: homeAboutData.desc }} />
                    <TransitionLink
                        href={'/about-us'}
                ...
                <div className='hidden md:block col-span-3 col-start-4 md:col-span-6 md:col-start-7 md:row-span-2 xl:col-span-4 xl:col-start-9'>
